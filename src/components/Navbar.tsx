            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-[#7dd3fc] to-[#a78bfa] transition-all duration-300 ${
                      isActive
                        ? "w-full"
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className={`block text-center py-4 text-xl font-light transition-colors duration-300 ${
                          isActive
                            ? "text-white"
                      ...
                      >
                        <span className="relative inline-block">
                          ...
                          {isActive && (
                            <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-[#7dd3fc] to-[#a78bfa]" />
                          )}
                        </span>
                      </Link>
