...
export default function PortfolioClient() {
  ...
  Mobile: always visible, fades in on scroll
*/}
<motion.div
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-6 lg:p-12 flex flex-col justify-center">
                  ...
                  <motion.h2
                    ...
                    /* Mobile: reduced size; Desktop: unchanged */
                  ...
                  <motion.p
                    ...
                    /* Mobile: slightly smaller body text */
                    ...
                    {["Next.js", "TypeScript", "Node.js", "React.js"].map((tag) => (
                      <span
                        ...
                        className="text-xs px-3 py-1.5 rounded-full
                          /* desktop */ lg:bg-white/[0.03] lg:border-white/[0.08] lg:text-[#a1a1aa]
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {projects.map((project, index) => (
                ...
                >
                  ...
                  >
                    {/* Radial glow — desktop on hover, mobile always on */}
                    ...
                    >
                      <motion.img
                        ...
                        /* Mobile: scale up slightly on scroll-enter for life */
                        ...
                        /* Desktop: keep existing hover scale via CSS group-hover */
